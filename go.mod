...
require (
	...
	golang.org/x/crypto v0.55.0 // indirect; CVE fixes for https://avd.aquasec.com/nvd/cve-2025-22869
...
require (
	...
	google.golang.org/grpc v1.83.2 // indirect; CVE-2026-84304 fix (https://avd.aquasec.com/nvd/cve-2026-84304)
