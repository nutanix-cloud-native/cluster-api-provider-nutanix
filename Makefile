...
unit-test: mocks  ## Run unit tests.
	CGO_ENABLED=0 KUBEBUILDER_ASSETS="$(KUBEBUILDER_ASSETS)" GOFLAGS="-buildvcs=false" \
	$(GOTEST) $(GOTESTPKGS)
...
lint: ## Lint the codebase
	CGO_ENABLED=0 GOFLAGS="-buildvcs=false" golangci-lint run -v
