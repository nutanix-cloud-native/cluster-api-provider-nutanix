...
func (r *NutanixFailureDomainReconciler) Reconcile(ctx context.Context, req ctrl.Request) (res ctrl.Result, reterr error) {
	...
	err = r.Get(ctx, req.NamespacedName, fd)
	if err != nil {
...
func (r *NutanixFailureDomainReconciler) reconcileDelete(ctx context.Context, fd *infrav1.NutanixFailureDomain) (res ctrl.Result, reterr error) {
	log := ctrl.LoggerFrom(ctx)
...
func (r *NutanixFailureDomainReconciler) reconcileNormal(ctx context.Context, fd *infrav1.NutanixFailureDomain) (res ctrl.Result, reterr error) {
	log := ctrl.LoggerFrom(ctx)
