...
func (r *NutanixMachineReconciler) addGuestCustomizationToVMV3(nctx *controllers.NutanixExtendedContext, scope *NutanixMachineScope, vmSpec *prismclientv3.VM) error {
	...
	if bootstrapRef.Kind == infrav1.NutanixMachineBootstrapRefKindSecret {
		bootstrapData, err := r.getBootstrapDataV3(nctx, scope)
		if err != nil {
			return err
		}
...
func (r *NutanixMachineReconciler) getBootstrapDataV3(nctx *controllers.NutanixExtendedContext, scope *NutanixMachineScope) ([]byte, error) {
