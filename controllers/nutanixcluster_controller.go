...
import (
	...
	capiutilv1beta1 "github.com/nutanix-cloud-native/cluster-api-provider-nutanix/pkg/capiutils" //nolint:staticcheck // suppress complaining on Deprecated type
...
func (r *NutanixClusterReconciler) Reconcile(ctx context.Context, req ctrl.Request) (res ctrl.Result, reterr error) {
	...
	capiCluster, err := capiutilv1beta1.GetOwnerCluster(ctx, r.Client, cluster.ObjectMeta)
	if err != nil {
	...
	if capiutilv1beta1.IsPaused(capiCluster, cluster) {
