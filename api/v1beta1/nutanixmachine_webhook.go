...
//+kubebuilder:webhook:verbs=create;update,path=/validate-infrastructure-cluster-x-k8s-io-v1beta1-nutanixmachine,mutating=false,failurePolicy=fail,groups=infrastructure.cluster.x-k8s.io,resources=nutanixmachines,versions=v1beta1,name=vnutanixmachine.kb.io,sideEffects=None,admissionReviewVersions=v1;v1beta1
...
func (r *NutanixMachine) ValidateUpdate(old runtime.Object) error {
	nutanixmachinelog.Info("validate update", "name", r.Name)
...
func (r *NutanixMachine) ValidateDelete() error {
	nutanixmachinelog.Info("validate delete", "name", r.Name)
