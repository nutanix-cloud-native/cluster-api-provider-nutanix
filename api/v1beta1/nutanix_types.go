...
// +union
// +kubebuilder:validation:XValidation:rule="self.type != 'name' || has(self.name)",message="the 'name' field must be present when the 'type' is 'name'"
// +kubebuilder:validation:XValidation:rule="self.type != 'uuid' || has(self.uuid)",message="'the 'uuid' field must be present when the 'type' is 'uuid'"
// +kubebuilder:validation:XValidation:rule="self.type != 'name' || !has(self.uuid)",message="the 'uuid' field cannot be set when the 'type' is 'name'"
// +kubebuilder:validation:XValidation:rule="self.type == 'uuid' && !has(self.name)",message="the 'name' field cannot be set when the 'type' is 'uuid'"
