...
const (
	...
	FailureDomainSafeForDeletionCondition = "FailureDomainSafeForDeletion"
	...
	NoFailureDomainsConfiguredCondition = "NoFailureDomainsConfigured"

	// FailureDomainsValidatedCondition indicates whether the failure domains are configured correctly or not.
	FailureDomainsValidatedCondition = "FailureDomainsValidated"
...
const (
	...
	ClusterCategoryCreatedCondition = "ClusterCategoryCreated"
...
const (
	...
	PrismCentralClientCondition   = "PrismClientInit"
	PrismCentralV4ClientCondition = "PrismClientV4Init"
...
const (
	...
	VMAddressesAssignedCondition = "VMAddressesAssigned"
...
const (
	...
	ProjectAssignedCondition = "ProjectAssigned"
...
const (
	...
	CredentialRefSecretOwnerSetCondition = "CredentialRefSecretOwnerSet"
