...
func (in *NutanixMachineSpec) DeepCopyInto(out *NutanixMachineSpec) {
	*out = *in
	...
	if in.VMPlacement != nil {
		in, out := &in.VMPlacement, &out.VMPlacement
		*out = new(NutanixMachineVMPlacement)
		**out = **in
	}
	if in.Project != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NutanixMachineVMPlacement) DeepCopyInto(out *NutanixMachineVMPlacement) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NutanixMachineVMPlacement.
func (in *NutanixMachineVMPlacement) DeepCopy() *NutanixMachineVMPlacement {
	if in == nil {
		return nil
	}
	out := new(NutanixMachineVMPlacement)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NutanixVMAntiAffinityPolicy) DeepCopyInto(out *NutanixVMAntiAffinityPolicy) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NutanixVMAntiAffinityPolicy.
func (in *NutanixVMAntiAffinityPolicy) DeepCopy() *NutanixVMAntiAffinityPolicy {
	if in == nil {
		return nil
	}
	out := new(NutanixVMAntiAffinityPolicy)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *NutanixVMAntiAffinityPolicy) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NutanixVMAntiAffinityPolicyList) DeepCopyInto(out *NutanixVMAntiAffinityPolicyList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]NutanixVMAntiAffinityPolicy, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NutanixVMAntiAffinityPolicyList.
func (in *NutanixVMAntiAffinityPolicyList) DeepCopy() *NutanixVMAntiAffinityPolicyList {
	if in == nil {
		return nil
	}
	out := new(NutanixVMAntiAffinityPolicyList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *NutanixVMAntiAffinityPolicyList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NutanixVMAntiAffinityPolicySpec) DeepCopyInto(out *NutanixVMAntiAffinityPolicySpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NutanixVMAntiAffinityPolicySpec.
func (in *NutanixVMAntiAffinityPolicySpec) DeepCopy() *NutanixVMAntiAffinityPolicySpec {
	if in == nil {
		return nil
	}
	out := new(NutanixVMAntiAffinityPolicySpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NutanixVMAntiAffinityPolicyStatus) DeepCopyInto(out *NutanixVMAntiAffinityPolicyStatus) {
	*out = *in
	if in.FailureMessage != nil {
		in, out := &in.FailureMessage, &out.FailureMessage
		*out = new(string)
	...
	if in.NumCompliantVms != nil {
		in, out := &in.NumCompliantVms, &out.NumCompliantVms
		*out = new(int64)
		**out = **in
	}
	if in.NumNonCompliantVms != nil {
		in, out := &in.NumNonCompliantVms, &out.NumNonCompliantVms
		*out = new(int64)
		**out = **in
	}
	if in.NumPendingVms != nil {
		in, out := &in.NumPendingVms, &out.NumPendingVms
		*out = new(int64)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NutanixVMAntiAffinityPolicyStatus.
func (in *NutanixVMAntiAffinityPolicyStatus) DeepCopy() *NutanixVMAntiAffinityPolicyStatus {
	if in == nil {
		return nil
	}
	out := new(NutanixVMAntiAffinityPolicyStatus)
	in.DeepCopyInto(out)
	return out
}
