...
func (in *NutanixMachineVMStorageConfig) DeepCopyInto(out *NutanixMachineVMStorageConfig) {
	*out = *in
	if in.StorageContainer != nil {
		...
		*out = new(NutanixStorageContainerResourceIdentifier)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NutanixStorageContainerResourceIdentifier) DeepCopyInto(out *NutanixStorageContainerResourceIdentifier) {
	*out = *in
	if in.Id != nil {
		in, out := &in.Id, &out.Id
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NutanixStorageContainerResourceIdentifier.
func (in *NutanixStorageContainerResourceIdentifier) DeepCopy() *NutanixStorageContainerResourceIdentifier {
	if in == nil {
		return nil
	}
	out := new(NutanixStorageContainerResourceIdentifier)
