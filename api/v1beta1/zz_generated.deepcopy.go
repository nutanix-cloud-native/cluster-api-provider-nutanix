...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PrismElementFailureDomainSpec) DeepCopyInto(out *PrismElementFailureDomainSpec) {
	*out = *in
	in.PrismElement.DeepCopyInto(&out.PrismElement)
	if in.Subnets != nil {
		in, out := &in.Subnets, &out.Subnets
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PrismElementFailureDomainSpec.
func (in *PrismElementFailureDomainSpec) DeepCopy() *PrismElementFailureDomainSpec {
	if in == nil {
		return nil
	}
	out := new(PrismElementFailureDomainSpec)
	in.DeepCopyInto(out)
	return out
}
