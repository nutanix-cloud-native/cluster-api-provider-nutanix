...
func (in *MovementGroup) DeepCopyInto(out *MovementGroup) {
	*out = *in
	...
	if in.RecoveryPlans != nil {
		in, out := &in.RecoveryPlans, &out.RecoveryPlans
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MovementGroup.
func (in *MovementGroup) DeepCopy() *MovementGroup {
	if in == nil {
		return nil
	}
	out := new(MovementGroup)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MovementGroupStatus) DeepCopyInto(out *MovementGroupStatus) {
	*out = *in
	if in.MetroSite != nil {
		in, out := &in.MetroSite, &out.MetroSite
		*out = new(NutanixVHADomainMetroSiteStatus)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MovementGroupStatus.
func (in *MovementGroupStatus) DeepCopy() *MovementGroupStatus {
	if in == nil {
		return nil
	}
	out := new(MovementGroupStatus)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NutanixVHADomainMetroSiteResourceStatus) DeepCopyInto(out *NutanixVHADomainMetroSiteResourceStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NutanixVHADomainMetroSiteResourceStatus.
func (in *NutanixVHADomainMetroSiteResourceStatus) DeepCopy() *NutanixVHADomainMetroSiteResourceStatus {
	if in == nil {
		return nil
	}
	out := new(NutanixVHADomainMetroSiteResourceStatus)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NutanixVHADomainMetroSiteStatus) DeepCopyInto(out *NutanixVHADomainMetroSiteStatus) {
	*out = *in
	if in.FailureDomains != nil {
		in, out := &in.FailureDomains, &out.FailureDomains
		*out = make(map[string]*NutanixVHADomainMetroSiteResourceStatus, len(*in))
		for key, val := range *in {
			var outVal *NutanixVHADomainMetroSiteResourceStatus
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NutanixVHADomainMetroSiteStatus.
func (in *NutanixVHADomainMetroSiteStatus) DeepCopy() *NutanixVHADomainMetroSiteStatus {
	if in == nil {
		return nil
	}
	out := new(NutanixVHADomainMetroSiteStatus)
...
func (in *NutanixVirtualHADomainSpec) DeepCopyInto(out *NutanixVirtualHADomainSpec) {
	*out = *in
	...
	if in.MovementGroups != nil {
		...
		*out = make(map[string]MovementGroup, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
func (in *NutanixVirtualHADomainStatus) DeepCopyInto(out *NutanixVirtualHADomainStatus) {
	*out = *in
	...
	if in.MovementGroups != nil {
		in, out := &in.MovementGroups, &out.MovementGroups
		*out = make(map[string]MovementGroupStatus, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
