...
var nutanixclustertemplatelog = logf.Log.WithName("nutanixclustertemplate-resource")

// SetupWebhookWithManager will setup the manager to manage the webhooks
func (r *NutanixClusterTemplate) SetupWebhookWithManager(mgr ctrl.Manager) error {
...
func (r *NutanixClusterTemplate) Default() {
	nutanixclustertemplatelog.Info("default", "name", r.Name)
...
func (r *NutanixClusterTemplate) ValidateCreate() (admission.Warnings, error) {
	nutanixclustertemplatelog.Info("validate create", "name", r.Name)
...
func (r *NutanixClusterTemplate) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
	nutanixclustertemplatelog.Info("validate update", "name", r.Name)
...
func (r *NutanixClusterTemplate) ValidateDelete() (admission.Warnings, error) {
	nutanixclustertemplatelog.Info("validate delete", "name", r.Name)
