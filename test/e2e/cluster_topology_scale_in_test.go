...
var _ = Describe("When scaling in cluster with topology ", Label("clusterclass", "cluster-topology-scale-in"), func() {
	...
	It("Scale in a cluster with topology from 3 CP node to 1 CP nodes with Kube127", func() {
	...
	It("Scale in a cluster with topology from 3 Worker node to 1 Worker nodes with Kube127", func() {
		clusterName = testHelper.generateTestClusterName(specName)
		Expect(clusterName).NotTo(BeNil())
	...
	It("Scale in a cluster with topology from 3 CP and Worker node to 1 CP and Worker nodes with Kube127", func() {
		clusterName = testHelper.generateTestClusterName(specName)
		Expect(clusterName).NotTo(BeNil())
	...
	It("Scale in a cluster with topology from 3 CP node to 1 CP nodes with Kube128", func() {
		clusterName = testHelper.generateTestClusterName(specName)
		Expect(clusterName).NotTo(BeNil())
	...
	It("Scale in a cluster with topology from 3 Worker node to 1 Worker nodes with Kube128", func() {
		clusterName = testHelper.generateTestClusterName(specName)
		Expect(clusterName).NotTo(BeNil())
	...
	It("Scale in a cluster with topology from 3 CP and Worker node to 1 CP and Worker nodes with Kube128", func() {
		clusterName = testHelper.generateTestClusterName(specName)
		Expect(clusterName).NotTo(BeNil())
	...
	It("Scale in a cluster with topology from 3 CP node to 1 CP nodes with Kube129", func() {
		clusterName = testHelper.generateTestClusterName(specName)
		Expect(clusterName).NotTo(BeNil())
	...
	It("Scale in a cluster with topology from 3 Worker node to 1 Worker nodes with Kube129", func() {
		clusterName = testHelper.generateTestClusterName(specName)
		Expect(clusterName).NotTo(BeNil())
	...
	It("Scale in a cluster with topology from 3 CP and Worker node to 1 CP and Worker nodes with Kube129", func() {
		clusterName = testHelper.generateTestClusterName(specName)
		Expect(clusterName).NotTo(BeNil())
