...
// NutanixClientCacheConvergedV4 is the cache of prism clients to be shared across the different controllers
var NutanixClientCacheConvergedV4 = convergedV4.NewClientCache(v4.WithSessionAuth(true))
